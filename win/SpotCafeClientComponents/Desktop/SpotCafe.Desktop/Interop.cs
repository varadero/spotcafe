...
namespace SpotCafe.Desktop {
    public class Interop {
        ...
        public static void Restart() {
            // Need to enable restart privilege like this:
            /*
             * Dim hProc As Long
Dim hToken As Long
Dim mLUID As LUID
...
LookupPrivilegeValue "", Fun_DecryptString("162549C241C9C18366DD3D8154AAA4FC879547D556DCE2"), mLUID ' "SeShutdownPrivilege", mLUID
...
AdjustTokenPrivileges hToken, False, mPriv, 4 + (12 * mPriv.PrivilegeCount), mNewPriv, 4 + (12 * mNewPriv.PrivilegeCount)
             */
            //return ExitWindowsEx(EWX_REBOOT | EWX_FORCE | EWX_FORCEIFHUNG, 0);
        ...
        public static void ShutDown() {
            LibClass.ExitWindows(RestartOptions.ShutDown, true);
            // return ExitWindowsEx(EWX_SHUTDOWN | EWX_FORCE | EWX_FORCEIFHUNG, 0);
        }
    ...
    public class LibClass {
        ...
        protected static void ExitWindows(int how, bool force) {
            ...
            if (force)
                how = how | EWX_FORCE | EWX_FORCEIFHUNG;
